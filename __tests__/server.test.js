...
describe('web server routes', () => {
  ...
  it('should respond with a 200 if the GET route is correct', async () => {
    // put in fake data here
    // check what params I used, I can't remember now.
    const data = {
      type: 'shirt',
  ...
  it('should respond with a 200 if the UPDATE route is correct', async () => {
    // put in fake data here
    // check what params I used, I can't remember now.
    const data = {
      type: 'shirt',
  ...
  it('should respond with a 200 if the DELETE route is correct', async () => {
    // put in fake data here
    // check what params I used, I can't remember now.
    const data = {
      type: 'shirt',
